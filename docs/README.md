...
This folder contains documentation for developers working on the Zero Trust Assessment solution.
It includes information on how to set up the development environment, coding practices, and guidelines for contributing to the project.
